...
✅ **Song ngữ (13/07/2026):** docs dịch đủ 11 tài liệu (`docs/en/`); **UI editor song ngữ** — mặc định tiếng Việt, đổi bằng nút **VI/EN** hoặc `?lang=en` (cả tên 106 asset). Bản vẽ xuất ra giữ tiếng Việt (chủ đích — hồ sơ TCVN).
