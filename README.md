...
**Bilingual:** English README + full English design docs (`docs/en/`) + bilingual editor UI auto-detected by country (VN → vi, elsewhere → en; asset catalog included). Next up: local zoning rule packs, IFC export, photoreal rendering.
