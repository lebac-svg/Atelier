...
| Đa typology & đa vùng | ✅ chốt hướng 14/07/2026 — lộ trình P6–P9 riêng ở [doc 12](12-mo-rong-typology.md) (rule-pack, mái dốc, đa mặt tiền, địa hình, thư viện template, region). **P6 (kiến trúc rule-pack) xong 14/07/2026** — pack là dữ liệu, chọn theo `config.region`, doc contributor [13](13-viet-rule-pack.md), 206 tests | P7 tiếp |
